...
/**
 * This is the model class for table "field_data_body".
 *
 ...
 */
class FieldDataBody extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['body_value', 'body_summary'], 'string'],
            [['entity_type', 'bundle'], 'string', 'max' => 128],
            [['language'], 'string', 'max' => 32],
            [['body_format'], 'string', 'max' => 255]
        ];
    }
