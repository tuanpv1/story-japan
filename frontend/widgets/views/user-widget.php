...
<div class="box-authentication">
    ...
    <p><b><?= Yii::t('app', 'Email: ') ?></b> <?= $model->email ? $model->email : Yii::t('app', 'Updating...') ?></p>
    <br>
    <p><b><?= Yii::t('app', 'Address') ?></b> <?= $model->address ? $model->address : Yii::t('app', 'Updating...') ?>
    </p>
    <br>
    <p><b><?= Yii::t('app', 'Phone: ') ?></b> <?= $model->phone ? $model->phone : Yii::t('app', 'Updating...') ?></p>
    <br>
    <p><b><?= Yii::t('app', 'About: ') ?></b> <?= $model->about ? $model->about : Yii::t('app', 'Updating...') ?></p>
    <br>
