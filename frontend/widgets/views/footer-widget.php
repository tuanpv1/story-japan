<footer id="footer">
    <div class="container">
        ...
        <div id="introduce-box" class="row">
            <div class="col-md-3">
                <div id="address-box">
                    <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/introduce-logo.png" alt="" /></a>
                    <div id="address-list">
                        <div class="tit-name">Address:</div>
                        <div class="tit-contain">124 Hoàng Quốc Việt, Hà Nội, Việt Nam</div>
                        <div class="tit-name">Phone:</div>
                        <div class="tit-contain">+84 1688 929 947</div>
                        <div class="tit-name">Email:</div>
                        <div class="tit-contain">hungnd1292@gmail.com</div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div id="trademark-box" class="row">
            <div class="col-sm-12">
                <ul id="trademark-list">
                    ...
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-ups.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-qiwi.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-wu.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-cn.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-visa.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-mc.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-ems.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-dhl.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-fe.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/data/trademark-wm.jpg"  alt="ups"/></a>
                    </li>
                </ul>
            </div>
        </div> <!-- /#trademark-box -->
...
<!--        </div><!-- /#trademark-text-box -->
        <div id="footer-menu-box">
            ...
            <p class="text-center">Copyrights &#169; 2017 KuteShop. All Rights Reserved. Designed by HungND and TuanPV</p>
        </div><!-- /#footer-menu-box -->
    </div>
</footer>
