...
<div id="tp_id_reload_lmc" class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="page-content page-order">
            ...
            <div id="number_total_cart"
                 class="heading-counter warning"><?= Yii::t('app', 'Tổng số sản phẩm trong giỏ hàng của bạn ') ?>:
                ...
                <div class="order-detail-content">
                                ...
                                <tr>
                                    ...
                                    <td class="price">
                                        <span><?= CUtils::formatNumber($value['price_promotion'] ? $value['price_promotion'] : $value['price']) ?>
                                            VND</span></td>
                                    <td class="qty">
                                        <input id="amount_<?= $key ?>" class="form-control input-sm" type="text"
                                               value="<?= $value['amount'] ?>">
                                        <a onclick="addition(<?= $key ?>)" href="javascript:void(0)"><i
                                                    class="fa fa-caret-up"></i></a>
                                        <a onclick="subtraction(<?= $key ?>)" href="javascript:void(0)"><i
                                                    class="fa fa-caret-down"></i></a>
                                    </td>
                                    <td class="price">
                                        <span><?= CUtils::formatNumber(($value['price_promotion'] ? $value['price_promotion'] : $value['price']) * $value['amount']) ?>
                                            VND</span>
                                    </td>
                                    <td class="action">
                                        <a onclick="delCart(<?= $key ?>)"
                                           href="javascript:void(0)"><?= Yii::t('app', 'Xóa') ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
                                ...
                                <div class="col-sm-6">
                                    <div class="box-authentication">
                                        ...
                                        <input class="form-control" type="text" name="full_name" id="full_name"
                                               placeholder="Pham Van A" value="<?php
                                        ...
                                        ?>">
                                        <label id="name_mua" style="color:red;float: right">Không được để trống tên
                                            người mua hàng</label><br>

                                        <div class="col-md-6 col-sm-12">
                                            <?= Yii::t('app', 'Địa chỉ email người mua hàng (*)') ?>
                                        </div>
                                        <input class="form-control" type="email" name="user_email"
                                               placeholder="example@gmail.com" id="user_email"
                                        ...
                                        <input class="form-control" type="tel" name="user_phone"
                                               placeholder="09434xxxxx" id="user_phone"
                                        ...
                                        <input class="form-control" type="text" name="user_adress"
                                               placeholder="Số nhà A, Ngõ B, Từ Liêm, Hà Nội" id="user_adress"
                                               value="<?= !(Yii::$app->user->isGuest) ? Yii::$app->user->identity->address : "" ?>">
                                        <label id="dc_mua" style="color:red;float: right">Không được để trống địa chỉ
                                            người mua hàng</label>
                                    </div>
                                </div>

                                <div class="col-sm-6 text-center" id="buy_for_friend">
                                    <a class="default-btn text-center" onclick="showFormReceiver()"
                                ...
                                <div id="user_receiver_show_clicked" class="col-sm-6">
                                    <div class="box-authentication">
                                        ...
                                        <input class="form-control" type="text" name="fullName" id="fullName"
                                               placeholder="Phạm Văn B" value="">
                                        <label id="name_nhan" style="color:red;float: right">Không được để trống tên
                                            người nhận hàng</label><br>
                                        <div class="col-md-6 col-sm-12">
                                            <?= Yii::t('app', 'Địa chỉ Email người nhận hàng') ?>
                                        </div>
                                        <input class="form-control" type="email" name="userEmail"
                                               placeholder="exampleb@gmail.com" id="userEmail" value="">
                                        <label style="color:red;float: right">
                                        ...
                                        <input class="form-control" type="tel" name="userPhone"
                                               placeholder="09134xxxxxx" id="userPhone" value="">
                                        <label style="color:red;float: right">
                                        ...
                                        <input class="form-control" type="text" name="userAdress"
                                               placeholder="Số nhà A, Ngõ B, Hồng Bàng, Hải Phòng" id="userAdress"
                                               value="">
                                        <label id="dc_nhan" style="color:red;float: right">Không được để trống địa chỉ
                    ...
                    <div class="cart_navigation">
                        ...
                        <a class="next-btn" id="checkout" onclick="checkOutInfo()"
                           href="javascript:void(0)"><?= Yii::t('app', 'Đặt hàng') ?></a>
                    </div>
                </div>
            <?php } else {
                ?>
